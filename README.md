...
| [cx_campaign\* sendto="email@addre.ss" campaignid="x" codeinname="abc" ]<br>                                                                                                    | Displays a Carerix campaign signup form. Only active campaigns (end-date not expired) are listed.<br><br>Note: the intended functionality may no longer work due to functional changes in the Carerix system.                                                                                            |
